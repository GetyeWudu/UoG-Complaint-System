...
| # | Username | Email | Password | Role | Dashboard |
|---|----------|-------|----------|------|-----------|
| 1 | **student@example.com** | student@test.com | student123 | Student | Student Dashboard |
| 2 | **abebe** | abebe@uog.edu.et | *(unknown)* | Student | Student Dashboard |
| 3 | **gech** | wudugetye@gmail.com | *(unknown)* | Student | Student Dashboard |
| 4 | **academic** | academic@test.com | academic123 | Academic Staff | Academic Staff Dashboard |
| 5 | **staff@example.com** | staff@example.com | *(unknown)* | Academic Staff | Academic Staff Dashboard |
| 6 | **nonacademic** | nonacademic@test.com | nonacademic123 | Non-Academic Staff | Non-Academic Staff Dashboard |
| 7 | **nonstaff@example.com** | nonstaff@example.com | *(unknown)* | Non-Academic Staff | Non-Academic Staff Dashboard |
| 8 | **proctor** | proctor@test.com | proctor123 | Proctor | Proctor Dashboard |
| 9 | **proctor_1** | proc@uog.edu.et | *(unknown)* | Proctor | Proctor Dashboard |
| 10 | **depthead** | depthead@test.com | depthead123 | Department Head | Department Head Dashboard |
| 11 | **depthead@example.com** | depthead@example.com | *(unknown)* | Department Head | Department Head Dashboard |
| 12 | **head_cs** | head@uog.edu.et | *(unknown)* | Department Head | Department Head Dashboard |
| 13 | **dean** | dean@test.com | dean123 | Dean | Dean Dashboard |
| 14 | **dean_info** | dean@uog.edu.et | *(unknown)* | Dean | Dean Dashboard |
| 15 | **maintenance** | maintenance@test.com | maintenance123 | Maintenance Worker | Maintenance Dashboard |
| 16 | **maint@example.com** | maint@example.com | *(unknown)* | Maintenance Worker | Maintenance Dashboard |
| 17 | **admin** | admin@test.com | admin123 | Admin | Admin Dashboard |
| 18 | **admin@example.com** | admin@example.com | *(unknown)* | Admin | Admin Dashboard |
| 19 | **getye** | admin@uog.edu.et | *(unknown)* | Admin | Admin Dashboard |
| 20 | **superadmin** | superadmin@test.com | superadmin123 | Super Admin | Super Admin Dashboard |
| 21 | **super@example.com** | super@example.com | *(unknown)* | Super Admin | Super Admin Dashboard |
| 22 | **director** | director@test.com | director123 | Campus Director | Campus Director Dashboard
